...
\usepackage{pstool} % Moritz
\usepackage{psfrag} % Moritz

\graphicspath{{../bilder/}}
\input{./wer_commands_dg.tex} % Abkürzungen etc.
...
\input{Kapitel/02_Dynamic_Optimization.tex}
\input{Kapitel/03_Solving the Optimal Control Problem.tex}
\input{Kapitel/04_Comparison of the Approaches.tex}
\input{Kapitel/05_Receding Horizon Optimization.tex}
\input{Kapitel/06_Conclusion.tex}
